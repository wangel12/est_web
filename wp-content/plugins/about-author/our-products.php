...
#product_decs p {font-size:22px; text-align: center;}
...
<div class="block ui-tabs-panel deactive" id="option-ourproduct">
	<div class="row-fluid pricing-table pricing-three-column">
		<div class="plan-name centre">
			<a style="margin-bottom:10px;textt-align:center" target="_new" href="http://weblizar.com"><img  src="<?php echo WEBLIZAR_ABOUT_ME_PLUGIN_URL.'settings/images/weblizar2.png'; ?>" /></a>
			<div class="purchase_btn_div">
			</div>
		</div>
		<div class="plan-name">
			<h2>Weblizar Responsive WordPress Themes & Plugins</h2>
			<h6>Get The Premium Product & Create Your Website Beautifu</h6>
		</div>
		<div class="section container">
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					...
					<li><a href="https://weblizar.com/themes/healthcare/">Health Care</a></li>
					<li><a href="https://weblizar.com/themes/chronicle-premium-theme/">Chronicle</a></li>
			...
			<div class="col-lg-6">
				...
				<ol id="weblizar_product">
					<li><a href="https://weblizar.com/ultimate-responsive-image-slider-pro/">Ultimate Responsive Image Slider</a></li>
					<li><a href="https://weblizar.com/plugins/responsive-photo-gallery-pro//">Responsive Photo Gallery</a></li>
					<li><a href="https://weblizar.com/plugins/responsive-portfolio-pro/">Responsive Portfolio</a></li>
					<li><a href="https://weblizar.com/lightbox-slider-pro/">Lightbox Slider</a></li>
					<li><a href="https://weblizar.com/plugins/photo-video-link-gallery-pro/">Photo Video Link Gallery</a></li>
					<li><a href="https://weblizar.com/plugins/flickr-album-gallery-pro/">Flickr Album Gallery</a></li>
					<li><a href="https://weblizar.com/plugins/instagram-gallery-pro/">Instagram Gallery</a></li>
					<li><a href="https://weblizar.com/plugins/gallery-pro/">Gallery Pro Weblizar</a></li>
				</ol>
			</div>
		</div>
