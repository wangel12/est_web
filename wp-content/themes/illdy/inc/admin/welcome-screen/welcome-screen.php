...
class illdy_Welcome {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_illdy_dismiss_required_action', array( $this, 'illdy_dismiss_required_action_callback') );
		add_action( 'wp_ajax_nopriv_illdy_dismiss_required_action', array($this, 'illdy_dismiss_required_action_callback') );
